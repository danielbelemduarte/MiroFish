...
/**
 * Obter perfis de Agent da simulação
 * @param {string} simulationId
...
/**
 * Obter perfis de Agent em tempo real durante a geração
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Obter configuração da simulação em tempo real durante a geração
 * @param {string} simulationId
...
/**
 * Obter estado de execução da simulação em tempo real
 * @param {string} simulationId
 */
...
/**
 * Obter estado detalhado da execução da simulação (inclui ações recentes)
 * @param {string} simulationId
 */
...
/**
 * Obter publicações da simulação
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
...
/**
 * Obter timeline da simulação (resumo por rondas)
 * @param {string} simulationId
 * @param {number} startRound - Ronda inicial
 * @param {number} endRound - Ronda final
 */
 ...
 * Usado para apresentação de projetos históricos na página inicial
