        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A quick conversational version of the report generation agent, able to call 4 professional tools, with full MiroFish memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Alinha dados reais com o estado do ambiente simulado, combina mecanismos de Memória Global/Local para fornecer análise de atribuição profunda cross-temporal</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Algoritmo de travessia em largura baseado em grafos, reconstrói caminhos de propagação de eventos, captura a topologia completa do fluxo de informação</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">QuickSearch Pesquisa Rápida</div>
                    <div class="tool-desc">Interface de consulta instantânea baseada em GraphRAG, otimiza eficiência de indexação para extração rápida de atributos de nós e factos discretos</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Entrevista autónoma, capaz de realizar diálogos paralelos com indivíduos no mundo simulado, recolhendo dados de opinião não estruturados e estados psicológicos</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Converse com o Report Agent para explorar o conteúdo do relatório' : 'Converse com indivíduos simulados para conhecer as suas opiniões' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            <div class="setup-section">
              ...
              <div class="selection-actions">
                <button class="action-link" @click="selectAllAgents">Selecionar tudo</button>
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Digite a pergunta para todos os alvos selecionados..."
                rows="3"
              ></textarea>
            </div>
...
const chatHistoryCache = ref({}) // Cache de todos os registos de conversa: { 'report_agent': [], 'agent_0': [], 'agent_1': [], ... }
...
// Guardar registo de conversa atual na cache
...
const selectReportAgentChat = () => {
  // Guardar registo de conversa atual
  saveChatHistory()
  ...
  // Restaurar registo de conversa do Report Agent
...
const selectAgent = (agent, idx) => {
  ...
  // Restaurar registo de conversa deste Agent
...
const renderMarkdown = (content) => {
  ...
  // Limpar espaços antes da tag de fecho de lista
  ...
  // Limpar <p><br> seguido de elementos de bloco (causado por linhas em branco extra)
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Limpar tags <br> consecutivas
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Limpar <br> antes de tag de abertura de parágrafo após elementos de bloco
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Corrigir numeração de listas ordenadas não contíguas: manter numeração crescente quando <ol> de item único são separados por conteúdo de parágrafo
...
const sendMessage = async () => {
  ...
  try {
    ...
    scrollToBottom()
    // Guardar automaticamente registo de conversa na cache
    saveChatHistory()
  }
}
...
const sendToReportAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    throw new Error(res.error || 'Pedido falhou')
  }
}
...
const sendToAgent = async (message) => {
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .join('\n')
    prompt = `Segue o nosso diálogo anterior:\n${historyContext}\n\nA minha nova pergunta é: ${message}`
  }
  ...
  if (res.success && res.data) {
    // Caminho de dados correto: res.data.result.results é um dicionário de objetos
    // Formato: {"twitter_0": {...}, "reddit_0": {...}} ou plataforma única {"reddit_0": {...}}
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData

    // Converter dicionário de objetos em array, priorizar resposta da plataforma reddit
...
const submitSurvey = async () => {
  ...
  addLog(`A enviar questionário a ${selectedAgents.value.size} alvos...`)
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Converter dicionário de objetos em formato array
...
const loadReportData = async () => {
  ...
  try {
    addLog(`A carregar dados do relatório: ${props.reportId}`)
...
const loadAgentLogs = async () => {
  ...
  try {
    ...
    addLog(`Falha ao carregar registos do relatório: ${err.message}`)
  }
}
...
// Lifecycle
onMounted(() => {
  addLog('Passo 5 - Inicialização da interação profunda')
  loadReportData()
  loadProfiles()
...
/* Corrigir numeração de lista ordenada - usar contadores CSS para numerar múltiplos ol consecutivamente */
.message-text {
